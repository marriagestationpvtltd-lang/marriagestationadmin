...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _sendReportToAdmin(
    ...
    try {
      ...
      final userData = jsonDecode(userDataString);
      final reporterUserId = userData["id"].toString();
      final reporterName =
      ...
      final reportData = {
        ...
        'reportedName': userProfile.name.isNotEmpty
            ? userProfile.name
            : 'MS: ${widget.userId}',
        'reportedProfileImage': userProfile.avatarUrl,
      ...
      final ids = [reporterUserId, '1']..sort();
      final conversationId = '${ids[0]}_${ids[1]}';
      await FirebaseFirestore.instance
          .collection('conversations')
          .doc(conversationId)
          .set({
        'participants': [reporterUserId, '1'],
        'lastMessage': 'Profile Reported: ${reportData['reportedName']}',
...
class _MatchedProfileCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Check if photo request is accepted
    final bool canViewPhoto = profile.photoRequest.toLowerCase() == 'accepted';
